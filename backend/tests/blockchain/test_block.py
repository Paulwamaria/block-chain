...
def test_is_valid_block_bad_last_hash(last_block, block):
    ...
    block.last_hash = 'evil_last-hash'
...
def test_is_valid_bad_proof_of_work(last_block, block):
    ...
    with pytest.raises(Exception, match = 'Proof of work requirements was not met'):
        Block.is_valid_block(last_block, block)
...
def test_is_valid_block_bad_hash(last_block, block):
    ...
    with pytest.raises(Exception, match = 'block.hash mmust be correct'):
        Block.is_valid_block(last_block, block)
